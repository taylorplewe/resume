...
@Component({
  selector: 'app-page-experience',
  templateUrl: './page-experience.component.html',
  styleUrls: ['./page-experience.component.less']
})
export class PageExperienceComponent extends PageParent implements AfterViewInit {
